...
<main class="d-flex flex-column">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb m-0">
      ...
      <li class="breadcrumb-item"><a href="#">Catgeories</a></li>
  ...
  <article class="flex-grow-1 d-lg-flex align-items-stretch">
    <div class="col-lg-7 p-5">
      <header class="jumbotron post-header">
        ...
        <hr class="my-4">
        <p class="m-0">Dans la catégorie : <span class="badge badge-dark">{{$post->category->category}}</span></p>
        <small>
            Rédigé par
            <strong>
    ...
    <aside class="col-lg-5 p-5 bg-secondary text-light">
      ...
      <ul class="list-group text-white">
        ...
        <li class="list-group-item bg-dark">
          ...
          Rédigé par
          <strong>{{$post->comments[0]->comment}}</strong>
          <div class="py-2"></div>
        </li>
